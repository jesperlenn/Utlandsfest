export function IcRoundSearch(props: any) {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' className="size-5 hover:size-6 transition-all cursor-pointer" viewBox='0 0 24 24' {...props}>
      <path
        fill='currentColor'
